...
public class RMLUnValidatedMappingExtractor implements RMLMappingExtractor{
    ...
    public RMLSesameDataSet skolemizeStatements(RMLSesameDataSet rmlMappingGraph) {
        ...
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.SUBJECT_MAP));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.PREDICATE_MAP));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.OBJECT_MAP));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.PARENT_TRIPLES_MAP));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.JOIN_CONDITION));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.GRAPH_MAP));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.CLASS));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.CONSTANT));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.TEMPLATE));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.R2RML_NAMESPACE + RMLVocabulary.R2RMLTerm.TERM_TYPE));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.RML_NAMESPACE + RMLVocabulary.RMLTerm.LOGICAL_SOURCE));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.RML_NAMESPACE + RMLVocabulary.RMLTerm.SOURCE));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.RML_NAMESPACE + RMLVocabulary.RMLTerm.REFERENCE_FORMULATION));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.RML_NAMESPACE + RMLVocabulary.RMLTerm.REFERENCE));
        skolemPredicates.add(
                vf.createURI(RMLVocabulary.RML_NAMESPACE + RMLVocabulary.RMLTerm.ITERATOR));
        skolemPredicates.add(RDF.TYPE);

        for (URI u : skolemPredicates) {
    ...
    public ObjectMap extractObjectMap(RMLSesameDataSet rmlMappingGraph,
        ...
        try {
            ...
            StdObjectMap result = new StdObjectMap(null, constantValue, dataType,
                    languageTag, stringTemplate, termType, inverseExpression, referenceValue);
            return result;
        } catch (Exception ex) {
            java.util.logging.Logger.getLogger(RMLUnValidatedMappingExtractor.class.getName()).log(Level.SEVERE, null, ex);
        } 
