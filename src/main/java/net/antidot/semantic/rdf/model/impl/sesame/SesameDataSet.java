...
public class SesameDataSet {
	...
	protected Repository currentRepository = null;
	...
	public void addFile(String filepath, RDFFormat format) {
		try {
			...
			try {
                                con.begin();
                                con.add(new File(filepath), RDFTYPE, format);
                                log.info("[SesameDataSet:addFile] namespaces " + con.getNamespaces());
                                log.info("[SesameDataSet:addFile] size " + con.size());
	   ...
	   public void addURI(String urlstring, RDFFormat format) {
        try {
            ...
            try {
                ...
                log.error("[SesameDataSet:addURI] error " + e);
            } finally {
                con.close();
            }
        } catch (Exception e) {
